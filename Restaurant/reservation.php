<?php
    ...
    if (isset($_POST['book_table'])) {
        if ($user_id != '') {
            ...
            $reserve_table->execute([$id,$user_id,$name,$email,$number,$select,$date,$tie,$coment]);
        ...
        <div class="form-container">
            <form action="" method="post">
                ...
                <div class="input-field">
                    ...
                    <input type="number" name="number" required placeholder="Enter Your Name">
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <textarea name="comment" cols="30" rows="10" required placeholder="add any comment you think is necessary"></textarea>                    
                </div>
